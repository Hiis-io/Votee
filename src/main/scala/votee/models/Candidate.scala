...
/**
 * Candidate represents the base contract of an election candidate implementation. Users should
 * extend this trait to implement a concrete candidate.
 *
 * @param id
 *   the candidates id
 * @see
 ...
 *   the candidates name
 * @param party
 *   candidates party if available
 */
final private[votee] case class PreferentialCandidate(
